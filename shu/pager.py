class Pagination(object):
    def __init__(self,totalCount,currentPage,perPageItemNumber=3,maxPageNum=7):
        # 数据总个数
    ...
    def page_str(self):
        ...
        if self.currentPage == 1:
            ...
            prev = "<li><a href='/index2.html?p=%s'>上一页</a></li>"%(self.currentPage-1,)
        ...
        if self.currentPage == self.num_pages:
            ...
            nex = "<li><a href='/index2.html?p=%s'>下一页</a></li>" % (self.currentPage + 1,)
